...
$sql = "INSERT INTO sucursal (nombre, url, direccion)". 
"VALUES ('".$nombre."', '".$target_file."' , '".$direccion."')";
              ...
              <div class="jumbotron">
                <h1>Registro agregado con exito</h1>               
                 <h2>A donde quieres ir:</h2><br><br>                
                        ...
                        <a class="btn btn-primary" href="registrar_sucursal.php">Agregar nuevo diseño</a>
                        <a class="btn btn-primary" href="sucursales.php">Consultar diseños</a>
