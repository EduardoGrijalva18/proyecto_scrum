...
<body class="body1">
 ...
 <?php
    ...
    $sql = "DELETE FROM ofertas WHERE ofertas_id=" . $id;
                ...
                <div class="jumbotron">
                  <h1>Registro eliminado con exito</h1>               
                   <h2>A donde quieres ir:</h2><br><br>                
                          ...
                          <a class="btn btn-primary" href="registrarDatos.php">Agregar nueva oferta de pintura</a>
                          <a class="btn btn-primary" href="consultarDatos.php">Consultar ofertas de pintura</a>
